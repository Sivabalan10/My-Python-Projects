...
def welcome():
    ...
    if hour >= 12 and hour <= 16:
        ...
        speak("i  am   avis , i   am   here   to  help  u  sir,")
...
def takecommand():
    ...
    with sr.Microphone() as source:
        ...
        if "tgfdrsd" in me:
            ...
            speak("i   literally    don't    know   what   to  tell! , but   i   can   store   it   in    my   memory.")
            f = open("brain.txt", "a")
            f.write("\n")
            f.write(me)
            f.write(",")
